			...
			<div class="row no-gutters m-0 bg-gray">
				<div class="col-md-5 col-lg-2">
					<div class="category-lists d-flex flex-md-column flex-wrap">
						<a
							href="javascript:;"
							@click="getProducts('motors', $event)"
							class="active"
						>Motors</a>
						<a
							href="javascript:;"
							@click="getProducts('oneplus6', $event)"
						>Oneplus 6</a>
						<a
							href="javascript:;"
							@click="getProducts('power-bank', $event)"
						>Power Bank</a>
						<a
							href="javascript:;"
							@click="getProducts('smart-watch', $event)"
						>Smart Watch</a>
						<a
							href="javascript:;"
							@click="getProducts('type-c-cable', $event)"
						>Type-c Cable</a>
						<a
							href="javascript:;"
							@click="getProducts('xiaomi-mi-a2', $event)"
						>Xiaomi Mi A2</a>
						<a
							href="javascript:;"
